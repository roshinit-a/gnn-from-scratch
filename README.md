...
| $\tilde{D}$ | Diagonal degree matrix of $\tilde{A}$; $\tilde{D}{ii} = \sum_j \tilde{A}{ij}$ |
...
3. Compute degree: $\tilde{D}{ii} = \sum_j \tilde{A}{ij}$
...
| 2-Layer GCN | 80.3% | Same features + symmetric normalized adjacency; +23.3pp gain |
